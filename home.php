...
if($_SESSION['usr']){
	...
	<div id='mySidenav' class='sidenav'>
	  ...
	  <p class='teste'><a href='painel.php'>Editar Home</a></p>
	   <p class='teste'><a href='#'>Painel Posts</a></p>
	   <p class='teste'><a href='posts.php'>Ver Posts</a></p>
	  <p class='teste'><a href='sair.php'>Sair</a></p>
	</div>
		...
		if(isset($_SESSION['il'])){
			if($_SESSION['il']){
				...
				";    
						...
						echo "<div>
					  		<img class='ai' alt='ai' src='carrUm.php?id=1;'>
					</div>
					...
					foreach($padd as $atual){
						echo"
						  <div class='mySlides fade'>";
							...
							if($_SESSION['iUm']){
								echo"<img src='carrTres.php?id=4'>";
							}else{
						  ...
						  <div class='mySlides fade'>";
							if(isset($_SESSION['iDois'])){	
										if($_SESSION['iDois']){
											...
											echo"<img src='carrTres.php?id=2'>";
										}
									}else{
										echo"<img src='carrTres.php?id=4'>";
									}
						  ...
						  <div class='mySlides fade'>";
							if(isset($_SESSION['iTres'])){	
										if($_SESSION['iTres']){
											...
											echo"<img src='carrTres.php?id=3'>";
										}
									}else{
										echo"<img src='carrTres.php?id=4'>";
									}
...
";
    	...
    	$padd = $controle->selecionarPadrao();
			...
			echo"<img src='carrCinco.php?id=1' style='width:100%'>
		  </div>";
...
";
    	...
    	$padd = $controle->selecionarPadrao();
			...
			echo"<img src='carrCinco.php?id=2' style='width:100%'>
		  </div>";
		}
	}
	...
	if(isset($_SESSION['iDir'])){
		if($_SESSION['iDir'] == False){  
		  ...
		  <div class='column'>";
			...
			echo"<img src='carrCinco.php?id=3' style='width:100%'>
		  </div>";
		 }
	}
