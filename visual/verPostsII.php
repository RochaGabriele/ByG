...
echo "
	...
	<div id='mySidenav' class='sidenav'>
	  ...
	  <p class='teste'><a href='homeII.php'>Home</a></p>
	   <p class='teste'><a href='verPostsII.php'>Ver Posts</a></p>
	   <p class='teste'><a href='verPosts.php'>Administração</a></p>
	</div>
				...
				foreach($pos as $atual){
					...
					<div class='lin'>
				     		<div class='posts'>
								...
								<img class='iPost' src='../controle/carr.php?id={$atual->getId()};'>
				    		</div>
